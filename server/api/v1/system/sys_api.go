...
import (
	...
	systemRes "github.com/liuxing95/gin-react-admin/model/system/response"
...
func (s *SystemApi) CreateApi(c *gin.Context) {
	...
	if err != nil {
		global.GRA_LOG.Error("创建失败!", zap.Error(err))
...
func (s *SystemApi) DeleteApi(c *gin.Context) {
	var api system.SysApi
	err := c.ShouldBindJSON(&api)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
	...
	if err != nil {
		global.GRA_LOG.Error("删除失败!", zap.Error(err))
...
func (s *SystemApi) GetApiList(c *gin.Context) {
	...
	if err != nil {
		global.GRA_LOG.Error("获取失败!", zap.Error(err))
...
func (s *SystemApi) GetApiById(c *gin.Context) {
...
func (s *SystemApi) UpdateApi(c *gin.Context) {
	var api system.SysApi
	err := c.ShouldBindJSON(&api)
	if err != nil {
		response.FailWithMessage(err.Error(), c)
	...
	if err != nil {
		global.GRA_LOG.Error("修改失败!", zap.Error(err))
...
func (s *SystemApi) GetAllApis(c *gin.Context) {
...
func (s *SystemApi) DeleteApisByIds(c *gin.Context) {
