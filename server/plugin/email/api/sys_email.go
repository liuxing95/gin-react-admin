...
import (
	...
	email_response "github.com/liuxing95/gin-react-admin/plugin/email/model/response"
	"github.com/liuxing95/gin-react-admin/plugin/email/service"
	"go.uber.org/zap"
)
...
func (s *EmailApi) EmailTest(c *gin.Context) {
	...
	if err != nil {
		global.GRA_LOG.Error("发送失败!", zap.Error(err))
