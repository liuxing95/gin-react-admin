...
import (
	...
	"github.com/liuxing95/gin-react-admin/plugin/email/utils"
	"github.com/liuxing95/gin-react-admin/service"
	utils2 "github.com/liuxing95/gin-react-admin/utils"
	"go.uber.org/zap"
)
	...
	return func(c *gin.Context) {
		...
		if status != 200 {
			...
			if err := utils.ErrorToEmail(subject, str); err != nil {
				global.GRA_LOG.Error("ErrorToEmail Failed, err:", zap.Error(err))
			}
		}
	}
}
